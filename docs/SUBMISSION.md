...
- Evidence of training: `results/plots/`, `results/trained/`, and hosted Qwen GRPO artifact.
...
4. Watch active disruptions, airport zoom, live agent negotiation, and reward
   bars.
5. Open the Training page and inspect replay scorecards, curves, and the hosted
   Qwen GRPO artifact link.
